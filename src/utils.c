...
static int bucket_match(const hashtable_bucket_t *bucket, const blob_t *key,
...
static hashtable_bucket_t *bucket_get(const hashtable_t *table,
                                      unsigned int i) {
...
void *hashtable_get(hashtable_t *table, const blob_t *key,
                    hashtable_flags_t flags) {
...
void *hashtable_iterate(blob_t **key, hashtable_t *table,
                        hashtable_iterator_t *iter) {
